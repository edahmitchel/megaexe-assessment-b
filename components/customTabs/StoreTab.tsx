...
import Store from '../../assets/CustomTab/shop.png'
...
const StoreTab: React.FC<StoreTabProps> = ({ label, iconName, focused }) => {
    return (
        <View style={[styles.tabBarItem, { backgroundColor: focused ? '#edeafe' : 'transparent' }]}>
            <Image source={Store} style={{ width: 24 }} resizeMode='contain' />
