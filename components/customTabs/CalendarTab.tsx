...
import Calendar from '../../assets/CustomTab/calendar.png'
...
const CalendarTab: React.FC<CalendarTabProps> = ({ label, iconName, focused }) => {
    return (
        <View style={[styles.tabBarItem, { backgroundColor: focused ? '#edeafe' : 'transparent' }]}>
            <Image source={Calendar} style={{ width: 24 }} resizeMode='contain' />
