...
import Background from '../../assets/Onboarding/OnboardingTwo.png';
...
// create a component
type OnboardingOnScreenProp = StackNavigationProp<RootStackParamList, 'OnboardingTwo'>;
const OnboardingTwo = () => {
                ...
                >
                    <SafeAreaView style={{ flex: 1 }}>
                        ...
                        <View style={styles.LinearGradientContainer}>
                            <View style={{ height: 196, marginTop: "auto", maxWidth: 325 }}>
                                <Text style={{ fontSize: Platform.OS == "ios" ? 35 : 24, fontFamily: 'Poppins', color: colors.white, fontWeight: "500" }}>Prescriptions Plus.....</Text>
                                <Text style={{ fontSize: Platform.OS == "ios" ? 35 : 26, fontFamily: 'Poppins', color: colors.white, fontWeight: "500" }}>Your One-Stop Shop For Medicines, Equipment and More</Text>
...
const styles = StyleSheet.create({
    ...
    gradient: {
        ...
        flex: 1,
        height: screenHeight, // Adjust this percentage as needed
        // justifyContent: 'center',
        // alignItems: 'center',
        // borderWidth: 1,
        // borderColor: 'pink',
